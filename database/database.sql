...
INSERT INTO `web_bioskop film` (`Judul_Film`, `Durasi`, `ID_Kategori`, `image`, `Director`, `Deskripsi`, `Rating_Usia`, `Trailer_URL`, `Rating`) VALUES
...
('Avengers: Endgame', '03:01:00', 'AKSI', '1772676345_69a8e4916d67.jpg', 'Anthony & Joe Russo', 'Para Avengers yang tersisa melakukan perjalanan waktu untuk mengumpulkan batu infinity dan mengalahkan Thanos.', 'R', 'https://www.youtube.com/watch?v=TcMBFSGVi1c', 8.4),
...
('The Shadow Edge', '02:10:00', 'AKSI', '1772708553_The_Shadow_Ege.jpg', 'Jackie Chan', 'Film aksi Jackie Chan terbaru dengan koreografi pertarungan spektakuler dan cerita penuh intrik.', 'R', 'https://www.youtube.com/watch?v=dDuzTlur3NU', 7.5),
('The Fantastic Four: First Steps', '02:00:00', 'AKSI', '1775796822_69d882567a02e.jpg', 'Matt Shakman', 'Berlatar di versi alternatif tahun 1960-an, film ini mengisahkan asal-usul Fantastic Four.', 'R', 'https://www.youtube.com/watch?v=18QQWa5MEcs', 7.5),
...
('The Substance', '02:20:00', 'HOROR', '1775825668_69d89304a99fb.jpg', 'Coralie Fargeat', 'Sebuah film horor tubuh yang eksperimental tentang pencarian identitas dan kecantikan.', 'D', 'https://www.youtube.com/watch?v=LNlrGhBpYjc', 7.6),
...
('The Odyssey', '03:00:00', 'PETUALANG', '1777217859_69ee3143c060.jpg', 'Christopher Nolan', 'Epik petualangan berdasarkan puisi karya Homer tentang prajurit Yunani yang berjuang pulang ke rumah.', 'R', 'https://www.youtube.com/watch?v=iklicVKcoI8&t=1s', 8.7),
...
('The Killer', '02:00:00', 'THRILL', '1777217925_69ee3185619ee.jpg', 'John Woo', 'Film terbaru John Woo tentang seorang pembunuh bayaran yang meragukan pilihannya.', 'R', 'https://www.youtube.com/watch?v=zgNOS5ofQhw', 7.3),
...
('JWL001', '2026-05-01', '13:00:00', 1, 30),
('JWL002', '2026-05-02', '15:30:00', 1, 30),
('JWL003', '2026-05-03', '19:00:00', 3, 30),
('JWL004', '2026-05-04', '14:00:00', 5, 30),
('JWL005', '2026-05-05', '20:00:00', 5, 30),

('KLR001', '2026-05-01', '14:00:00', 2, 29),
('KLR002', '2026-05-02', '19:30:00', 2, 29),
('KLR003', '2026-05-03', '16:00:00', 4, 29),
('KLR004', '2026-05-04', '20:30:00', 6, 29),
('KLR005', '2026-05-05', '18:00:00', 6, 29),

('HBD001', '2026-05-01', '16:00:00', 3, 28),
('HBD002', '2026-05-02', '20:00:00', 3, 28),
('HBD003', '2026-05-03', '13:30:00', 7, 28),
('HBD004', '2026-05-04', '19:00:00', 8, 28),
('HBD005', '2026-05-05', '21:00:00', 8, 28),

('JWK001', '2026-05-01', '19:00:00', 4, 10),
('JWK002', '2026-05-03', '20:30:00', 6, 10),
('JWK003', '2026-05-05', '14:00:00', 2, 10),

('HMA001', '2026-05-01', '13:00:00', 1, 11),
('HMA002', '2026-05-03', '10:00:00', 3, 11),
('HMA003', '2026-05-05', '16:00:00', 1, 11),

('TTB001', '2026-05-01', '21:00:00', 7, 12),
('TTB002', '2026-05-03', '22:00:00', 7, 12),
('TTB003', '2026-05-05', '20:00:00', 3, 12),

('AVG001', '2026-05-01', '18:00:00', 4, 13),
('AVG002', '2026-05-03', '15:00:00', 4, 13),
('AVG003', '2026-05-05', '19:00:00', 4, 13),

('FNF001', '2026-05-02', '21:30:00', 7, 14),
('FNF002', '2026-05-04', '22:00:00', 7, 14),
('FNF003', '2026-05-05', '23:00:00', 7, 14),

('SHE001', '2026-05-02', '15:00:00', 2, 15),
('SHE002', '2026-05-04', '19:00:00', 2, 15),
('SHE003', '2026-05-05', '13:00:00', 1, 15),

('FFS001', '2026-05-02', '18:00:00', 4, 16),
('FFS002', '2026-05-04', '14:00:00', 6, 16),
('FFS003', '2026-05-05', '20:00:00', 4, 16),

('NRB001', '2026-05-02', '13:00:00', 3, 17),
('NRB002', '2026-05-04', '16:00:00', 5, 17),
('NRB003', '2026-05-05', '11:00:00', 3, 17),

('BLM001', '2026-05-02', '20:00:00', 5, 18),
('BLM002', '2026-05-04', '21:00:00', 5, 18),
('BLM003', '2026-05-05', '22:00:00', 8, 18),

('SUB001', '2026-05-02', '23:00:00', 7, 19),
('SUB002', '2026-05-04', '20:00:00', 7, 19),
('SUB003', '2026-05-05', '21:30:00', 7, 19),

('ZTP001', '2026-05-01', '10:00:00', 1, 20),
('ZTP002', '2026-05-03', '11:00:00', 3, 20),
('ZTP003', '2026-05-05', '09:00:00', 2, 20),

('LKL001', '2026-05-01', '15:00:00', 5, 21),
('LKL002', '2026-05-03', '17:00:00', 5, 21),
('LKL003', '2026-05-05', '19:00:00', 3, 21),

('KDL001', '2026-05-01', '16:00:00', 1, 22),
('KDL002', '2026-05-03', '14:00:00', 1, 22),
('KDL003', '2026-05-05', '18:00:00', 2, 22),

('AGL001', '2026-05-01', '20:00:00', 8, 23),
('AGL002', '2026-05-03', '21:00:00', 8, 23),
('AGL003', '2026-05-05', '22:30:00', 8, 23),

('SPM001', '2026-05-02', '16:00:00', 4, 24),
('SPM002', '2026-05-04', '18:00:00', 4, 24),
('SPM003', '2026-05-05', '15:00:00', 6, 24),

('WSH001', '2026-05-02', '10:00:00', 3, 25),
('WSH002', '2026-05-04', '11:00:00', 1, 25),
('WSH003', '2026-05-05', '10:00:00', 3, 25),

('ODY001', '2026-05-02', '19:00:00', 4, 26),
('ODY002', '2026-05-04', '20:00:00', 4, 26),
('ODY003', '2026-05-05', '17:00:00', 4, 26),

('MOT001', '2026-05-02', '14:00:00', 6, 27),
('MOT002', '2026-05-04', '15:00:00', 2, 27),
('MOT003', '2026-05-05', '13:00:00', 6, 27);